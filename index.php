...
<body>
  ...
  <div id="carouselExampleIndicators" style="top:70px" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img class="d-block w-100" height="50%" src="./includes/img/1.jpg" alt="First slide">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" height="50%" src="./includes/img/2.jpg" alt="Second slide">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" height="50%" src="./includes/img/3.jpg" alt="Third slide">
      </div>
    </div>
  ...
  <div class="row about-start">
    ...
    <div class="col-8 ab-font">
      It gives me an immense pleasure to introduce <mark>Dot Code Edification</mark>,
      to all the aspiring students. Since the inception of this great institute,
      we have an aim to provide quality education and develop competent students
      who are socially sensitive and committed to excellence to global arena.<br><br>
      This institute believes in a well rounded and pervasive student experiment to
      maximize learning opportunities. To achieve this, the institute provides the
      course structure that has been designed to enable the students to hone their
      managerial skills and get them acquainted with the new development taking place
      in the industry.<br><br>
      Our UG and PG programs are desgined to install knowledge, leadership,innovative
      spirit, team work and global perspective into the students. This kind of exposure
      provide here not just to train students for Educational superiority but also make
      them ready to face global challenges.
    </div>
  </div>
  <div class="row" style="flex-direction: row;">
    <div class="container col-11">
      <div class="card">
        ...
        <p class="contact-msg" style="text-align: center;">Try new thing and widen your
          horizons.Try something you've always wanted to but never got
          around to ,something that scares you, something that is very different from
  ...
  <section>
    ...
    <div class="course-card">
      <div class="col-12 card-body">
        <img src="./includes/img/a2 (2).jpg" alt="">
        <ul>
    ...
    <div class="testimonial-card">
      <div class="t-card-body">
        ...
        <ul>
          ...
          <p class="heading-para">Dot code Edification emphsizes hands-on learning ,which helps students
            gain practical experience and develop their skills in web development.
            The institute provide real world projects and assignments to students.</p>
        </ul>
      </div>
      <div class="t-card-body">
        <img src="./includes/img/2.jpg" alt="">
        <ul>
          ...
          <p class="heading-para">My experience with Dot Code Edification was quite well and I have
      ...
      <div class="t-card-body">
        ...
        <ul>
          ...
          <p class="heading-para">Dot code Edification provides you modern learning technique which is more
            effective. Here teachers influence you to do smart work for building your skills,
            confidence and to achieve your goals</p>
        </ul>
      </div>
    </div>
  </section>
